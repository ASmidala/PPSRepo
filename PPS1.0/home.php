        ...
        <div class="preference">
            <div id="search">
                <voice>   
                    ...
                    <button class="cb"><a href="chatbot.html">chatbot</a></button>
                </voice>
            </div>
           
                <write>
                    <img class="pyy2" src="img/PPS2.png">
                    <button class="wb"><a href="write.html">writeMode</a></button>
                </write>
                <div>
                    <nav class="dropdownmenu">
                        <ul>
                            <li><a href="">Menu</a>
                                <ul id="submenu">
                                    <li><a onclick="alert('Are You Sure?')" href="Home.html">Home</a></li>
                                    <li><a onclick="checker()" href="search.html">Search</a></li>
       ...
       <!-- <main>AI
        ...
        <footer id="footer"> 
           <h4 class="D"  >Developed by Mysterious Global Tech(MGT)</h4>
            ...
            <h4 class="C"> C 2023, mysterious global tech</h4>
