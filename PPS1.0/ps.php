...
<html lang="en">
    <head>
        ...
        <title>Pyramid Poverty-Solution</title>
    </head>
    <body>
        <!--<div class="dark-mode">
            <p class="body">body</p>-->
           <!-- <h1>Hello World</h1>
            <h2>Welcome to my Dark Mode</h2>
            <img  alt="test" src="https://livestream.dev/featured.png" width="100px" />
        ...
        <section id="Triangle">
            <div class="triangle">
                <a href="ps.html"><img class="Triangle" src="img/PPS2.png"></a>-->
            
        
            <div class="pyy">
                <!--<img src="img/bulletlogo.png" alt="py">-->
        <logo class="lo"><img  class="lo" src="img/bulletlogo.png"></logo>
        <section header>
            <p> Welcome to 21st Centuary Amazing Pyramid Poverty Scale.</p>           
             <h1>Choose your prefered Mode of service.</h1>
        <div class="preference">
            <div id="search">
                <voice>   
                    <img class="pyy1" src="img/PPS1.png">
                    <button on class="cb"><a onclick="checker()" href="chatbot.php">chatbot</a></button>
                </voice>
            </div>
           
                <write>
                    <img class="pyy2" src="img/PPS2.png">
                    <button class="wb"><a  href="write.php">writeMode</a></button>
                </write>
                <div>
                    <nav class="dropdownmenu">
                        <ul>
                            <li><a href="">Menu</a>
                                <ul id="submenu">
                                    <li><a onclick="myFunction()" href="#">Dark Mode</a></li>
                                    <li><a  href="home.php">Home</a></li>
                                    <li><a onclick="prompt()" href="search.php">Search</a></li>
                                    <li><a  onclick="alert('You are about to make payment!')" href="subscribe.php">Subscribe</a></li>
       ...
       <!-- <main>AI
            <li> Algorithm
                <he>decision-making three</he>
                <ol>MACHINE LEARNING
                    <h3>training of the chatbot</h3>
                </ol>
                <ol>-Neural link language
                    <h3>Input and Output operation</h3>
                </ol>
                <ol>Computer vision
                    <h3>gathering image with motion as well as video in current time using satelite and providing data according to economic variablesa</h3>
                </ol>

                <ol>Deep learning
                    <h3> connecting with IoT device</h3>
                    <h3>reading the codinate number, Dealing with geo location</h3>
                </ol>
            </li>
        </main>-->
    </section>
        <footer id="footer"> 
           <h4 class="D"  >Developed by Mysterious Global Tech(MGT)</h4>
            <!--<div class="duo">
            <h4 class="P">Phone no: +2348026668201</h4>
            <h4 class="A">Address: no 10 Biu Road gombe, gombe state </h4>
        </div>-->
            <div class="tg">
            <h4 class="G"><a href="saiduabubakarmidala1@gmail.com"><li class="t"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="25px" height="25px" viewBox="0 0 256 256" xml:space="preserve">
                ...
                <h4 class="gi"><a href="https://www.github.com/ASMidala">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="gray" width="30" height="30" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg></a></h4>
            <h4 class="T"><div><a href="https://www.twitter.com/ASMidala1" class="socials">
                <svg xmlns="http://www.w3.org/2000/svg" fill="blue"  width="30" height="30" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg>
                  </a></div></h4>
                </div>
                <div class="store">
                    <a href="https://www.appstore.com"><img src="img/app.jpg"></a> <a href="https://www.playstore.com"><img src="img/play.jpg"></a>
                </div>
                
            
            <h4 class="C"> &copy; 2023, mysterious global tech</h4>
